...
func newS3ChunkWriter(ctx context.Context, opts ClipV2ArchiverOptions, chunkName string, chunkPrefix string) (io.WriteCloser, error) {
	...
	key := fmt.Sprintf("%s-chunks/%s%s", chunkPrefix, chunkName, ChunkSuffix)
