...
type ContentCache interface {
	...
	GetFileFromChunksWithOffset(hash string, chunks []string, chunkBaseURL string, chunkSize int64, startOffset int64, endOffset int64, relOffset int64, dest []byte) (int, error)
